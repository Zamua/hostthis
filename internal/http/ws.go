...
type RoomRelay interface {
	...
	// MirrorDurable fans a committed durable change out to a room's live
	// hub (the live mirror of an HTTP PUT/DELETE).
	MirrorDurable(key relay.RoomKey, f relay.Frame)
}
