...
func (s stubBlobReader) Read(_ context.Context, _ domain.ManifestEntry) (io.ReadCloser, int64, error) {
...
func (f failingBlobReader) Read(_ context.Context, _ domain.ManifestEntry) (io.ReadCloser, int64, error) {
	return nil, 0, f.err
}
